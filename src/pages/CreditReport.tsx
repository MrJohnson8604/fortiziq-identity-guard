...
const faqs = [
  ...
  { q: "Isn't my credit report free? Why would I pay for this?", a: "You are entitled to a free credit report from each bureau once per year through AnnualCreditReport.com — and we encourage you to use it. But those free reports do not include your credit scores. This purchase gives you the reports AND your score from each bureau together, in one place, so you have the complete picture lenders actually use." },
  ...
  { q: "Is this a subscription?", a: "No. This is a one-time purchase, period. You will not be charged again unless you choose to buy another report or sign up for one of FortizIQ's monthly monitoring plans." },
  { q: "How fast will I get my reports and scores?", a: "As soon as your identity is confirmed — usually just a few minutes — your reports and scores from all three bureaus are available immediately." },
  { q: "Is my personal information safe?", a: "Yes. Everything is processed through a fully encrypted platform that meets the same independently verified security standards used by major banks and financial institutions. Your information is never sold, never shared with marketers, and only used to pull your credit reports." },
  { q: "What if I want to keep monitoring my credit going forward?", a: "FortizIQ offers monthly credit monitoring and full identity protection plans starting at $21.99/month. After your one-time report, you'll have the option to add ongoing monitoring if you'd like — but it's completely optional." },
];
