      ...
      <div className="container relative z-10 text-center max-w-5xl">
        ...
        <div className="flex flex-col items-center mb-4 -mt-2 animate-fade-up" style={{ animationDelay: "0.25s" }}>
          ...
          <a
            ...
            className="mt-1 inline-flex max-w-[92vw] items-center justify-center text-center px-4 sm:px-5 py-2.5 rounded-full border border-primary/60 bg-card/40 backdrop-blur text-xs sm:text-sm font-semibold text-primary leading-snug hover:bg-primary/10 transition-colors animate-glow-pulse"
          >
